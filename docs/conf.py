...
# -*- coding: utf-8 -*-
"""
mocli documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'mocli'))
...
project = u'mocli'
_full_version = mocli.__version__
author = mocli.__author__
copyright = mocli.__copyright__
...
latex_documents = [
    (master_doc, 'mocli.tex', u'mocli Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'mocli', 'mocli Documentation',
     [author], 1)
]
